...
const movieSuggestions = [
    ...
    "The Shawshank Redemption", "Inception", "The Godfather", "Interstellar", 
    "Pulp Fiction", "The Dark Knight", "Parasite", "Fight Club", "Forrest Gump", 
    "The Matrix", "Whiplash", "Gladiator", "La La Land", "The Grand Budapest Hotel", 
    "Joker", "The Social Network", "Everything Everywhere All at Once", "Dune (2021)", 
...
function searchMovie() {
    ...
    if (!found) alert("No matching movie found in the carousel.");
}
